...
Четыре инструмента поверх официального API Яндекс Вордстата:

- **`wordstat_suggest`** — частотности и похожие фразы по запросу, с разметкой шума (инфо-запросы, «бесплатно/скачать», вакансии, гео-хвосты), **адресуемым спросом** (сумма без мусора), готовым списком **минус-слов** и разбивкой по **интенту** (коммерч./инфо/навиг./бренд). Регион — по id геобазы (225 — Россия, 213 — Москва, 2 — Санкт-Петербург); фильтр по устройствам (десктоп/смартфоны/планшеты).
- **`wordstat_dynamics`** — помесячная динамика спроса за **последние 24 месяца**: сезонный пик и спад, тренд год-к-году, вердикт словами. Тоже с фильтром по устройствам.
- **`wordstat_cluster`** — похожие фразы, разложенные в **черновик групп объявлений**: кластер по слову-модификатору → имя группы, заголовок объявления и ключи. Готовый каркас семантики.
- **`wordstat_regions`** — распределение спроса **по регионам и городам**: affinityIndex (>100 — регион «горячее» среднего по стране) и показы в месяц.
